...
const initialItems: Item[] = [
    { id: '1', barcode: 'CODE39-EXAMPLE', createdAt: new Date('2026-01-27T09:18:11Z') },
    { id: '2', barcode: 'TEST-1234', createdAt: new Date('2026-01-26T14:30:00Z') },
    { id: '3', barcode: '*HELLO-WORLD*', createdAt: new Date('2026-01-25T11:00:00Z') },
];
